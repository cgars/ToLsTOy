...
class LEDTowers:
    ...
    def __sdi__(self, bit):
        ...
        """
        self.current_status = list(self.current_status)
...
class Control(threading.Thread):
    ...
    def set_values_and_start(self, color_protocol, shock_protocol, gui):
        # =======================================================================
    ...
    def send_event(self, event):
        ...
        """
        assert (isinstance(event, (ShockEvent, ColorEvent)))
...
class ColorEvent:
    ...
    def __repr__(self):
        return str((self.duration, self.start, self.blue, self.green))
...
class ShockEvent:
    ...
    def __repr__(self):
        return str((self.duration, self.start, self.intensity))
